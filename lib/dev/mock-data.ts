/**
 * DEV-ONLY: In-memory mock data matching the production type shapes.
 * Used by the admin API module when no backend is configured.
 */

import type { LearningProgram, School, Student, SyncStatus, Teacher } from '@/types';

export const DEV_SCHOOLS: School[] = [
  {
    id: 'school-001',
    name: 'Greenfield Primary',
    address: '12 Oak Avenue, Springfield',
    districtId: 'district-dev-001',
    adminIds: ['dev-admin-001'],
    teacherCount: 3,
    studentCount: 4,
    isActive: true,
  ...
  },
  {
    id: 'school-002',
    name: 'Sunridge High',
    address: '88 Hilltop Road, Shelbyville',
    districtId: 'district-dev-001',
    adminIds: ['dev-admin-001'],
    teacherCount: 1,
    studentCount: 1,
...
export const DEV_PROGRAMS: LearningProgram[] = [
  {
    ...
    subject: 'english',
    level: 'primary',
    description: 'Core literacy and reading comprehension for grades 1–6.',
    materialSources: ['youtube', 'custom'],
  ...
  {
    id: 'prog-002',
    name: 'Maths Discovery',
    subject: 'maths',
    level: 'intermediate',
    description: 'Problem-solving and numeracy for grades 3–8.',
    materialSources: ['khan_academy'],
